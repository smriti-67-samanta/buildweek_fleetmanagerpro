      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">FleetManagerPro</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Comprehensive fleet management solution for modern logistics and transportation companies. 
              Streamline your operations, reduce costs, and improve efficiency.
            </p>
            <div className="flex items-center space-x-4 text-gray-300">
              ...
              <div className="flex items-center">
                ...
                <span>support@fleetmanagerpro.com</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center text-gray-300 mb-4 md:mb-0">
            ...
            <span>123 Fleet Street, Logistics City, LC 12345</span>
          </div>
        ...
        <div className="border-t border-gray-700 mt-4 pt-4 text-center text-gray-300">
          <p>&copy; {currentYear} FleetManagerPro. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
